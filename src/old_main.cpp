...
TOGGLE(relayCtrl,setLed,"Relay: ",doNothing,noEvent,noStyle//,doExit,enterEvent,noStyle
  ,VALUE("On",HIGH,relayOn,noEvent)
  ,VALUE("Off",LOW,relayOff,noEvent)
);
...
MENU(mainMenu,"Main menu",doNothing,noEvent,wrapStyle
  ...
  ,SUBMENU(subMenu)
  ,SUBMENU(setLed)
  ,OP("Relay On",relayOn,enterEvent)
  ,OP("Rekay Off",relayOff,enterEvent)
...
result idle(menuOut& o,idleEvent e) {
  ...
  gfx.drawString(String(sensors.getTempCByIndex(0)), xpos, 50);
  //int getFontHeight = gfx.fontHeight();

  gfx.setTextSize(2);
  gfx.setTextColor(White, Black);
  gfx.setTextDatum(MC_DATUM);
  gfx.drawString("Long press any btn", xpos, 90);
